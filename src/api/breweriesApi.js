...
class BreweriesApi {
  static getBreweries() {
    return new Promise((resolve, reject) => {
      ...
      resolve(Object.assign([], breweries));
    });

  }

  static saveBrewerie(brewerie) {
    return new Promise((resolve, reject) => {
      this.checkBrewerieLoading();
      breweries.push(brewerie);
      resolve();
    });
  }

  static deleteBrewerie(brewerieId) {
    return new Promise((resolve, reject) => {
      this.checkBrewerieLoading();
      const indexOfBrewerie = breweries.findIndex(author => {
        author.id == brewerieId;
      });
